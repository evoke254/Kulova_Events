                        ...
                        <div class="flow-root mb-4">
                            <ul role="list" class="divide-y divide-gray-200 dark:divide-gray-700 mt-5">
                                ...
                                @elseif($loop->index == 0)
                                    ...
                                    <h5 class=" text-center font-semibold leading-none text-gray-900 dark:text-white mb-4">
                                        Candidates
                                    </h5>
                                @endif
                                @foreach($position->candidates as $cdt)
                                    <li class="py-3 mt-5 pl-10 sm:py-4 border-b border-gray-200 dark:border-gray-700 ">
