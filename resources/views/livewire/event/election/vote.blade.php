                                    ...
                                    <div class="justify-center">
                                        ...
                                        <ul role="list" class="divide-y divide-gray-100 overflow-hidden bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl">
                                            @foreach($pstn?->candidates as $counter => $cdt)
                                                <li class="" wire:poll.100ms wire:click="castVote">
                                                    <label class="relative flex justify-between gap-x-6 px-4 py-5 hover:bg-gray-50 sm:px-6 hover:cursor-pointer ">
                                                        <input wire:model="ballot_papers.{{$pstn->id}}.candidate" type="radio" value="{{$cdt->id}}" class="sr-only" >
