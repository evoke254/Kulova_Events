<div>
    ...
    <div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5 dark:bg-gray-800 dark:border-gray-700 w-full">
        <div class="w-full mb-1">
            <div class="mb-4">
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Campaign Templates</h1>
            </div>
            <div class="items-center justify-between block sm:flex md:divide-x md:divide-gray-100 dark:divide-gray-700">
                ...
                <a href="{{route('campaign-template.create')}}" class="inline-flex text-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800" type="button" data-drawer-target="create-campaign-modal" data-drawer-show="create-campaign-modal" aria-controls="create-campaign-modal">
                    Create
                </a>
            ...
            <div class="min-w-full align-middle">
                <div class="overflow-hidden shadow w-100">
                    <table class="min-w-full w-full divide-y divide-gray-200 dark:divide-gray-600 table-auto">
                        ...
                        @foreach($campaign_templates as $template)
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white"> {{$template->name}} </td>
                                {{--}}<td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white"> {{$template->subject}} </td>
                           --}}     <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <label class="relative inline-flex items-center mr-5 cursor-pointer">
                                        <input type="checkbox" class="sr-only peer" wire:change="updateStatus({{$template->id}})"
                                ...
                                <td class="p-4 space-x-2 whitespace-nowrap">
                                    <a href="{{route('campaign-template.edit', ['campaign_template' => $template->id])}}">

                                        <button class="inline-flex items-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800" type="button" data-drawer-target="create-campaign-modal" data-drawer-show="create-campaign-modal" aria-controls="create-campaign-modal"
