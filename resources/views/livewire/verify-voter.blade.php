        ...
        <div class="w-full max-w-4xl p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow dark:bg-gray-800 mb-3 foc">
            ...
            <div class="my-2">
                ...
                <div class="grid grid-cols-1 gap-4">
                    ...
                    <div class="w-1/2">
                        <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Code<span class="text-danger-500 mr-2">*</span></label>
                        <x-input type="number" wire:model="phone_no" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5
                    dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" />
                    </div>
                </div>
                <x-button lime wire:click="store" class=" px-5 py-3 text-base font-medium text-center text-white  rounded-lg ">Send SMS</x-button>
