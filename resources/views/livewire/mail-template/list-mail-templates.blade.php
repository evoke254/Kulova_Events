<div>
    ...
    <div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5 dark:bg-gray-800 dark:border-gray-700 w-full">
        <div class="w-full mb-1">
            <div class="mb-4">
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Email Templates</h1>
            </div>
        </div>
    </div>
                        ...
                        @foreach($mail_templates as $template)
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <td class="p-4 space-x-2 whitespace-nowrap">
                                    <a target=" _blank" href="{{route('mail.preview', ['emailTemplate' => $template->id])}}"
