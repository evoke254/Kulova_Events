                ...
                <div class="py-24 sm:py-32">
                    <div class="mx-auto max-w-7xl px-6 lg:px-8">
                        <div class="mx-auto max-w-2xl text-center">
                            <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Text-40 Events & Voting Management Platform</h1>
                            <p class="mt-6 text-lg leading-8 text-gray-600">
                            Empower Your Events, Engage Your Audience
                            </p>
                            <p class="mt-6 text-lg leading-8 text-gray-600">
                                Experience the future of event planning and voting coordination with our comprehensive system.
                                Take control of your events and elections like never before, making event
                                management a seamless and efficient process. From Concept to Completion, Phishing Simulator is the ultimate leader Master Event and Voting Logistics.
                            </p>
