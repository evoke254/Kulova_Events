<nav x-data="{ open: false }" class="fixed z-30 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="#" class="flex ml-2 md:mr-24">
                    <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white mx-4">{{ substr(env('APP_NAME'), 0, 7)  }}</span>
            ...
            <div class="flex items-center">
                ...
                <!-- Notifications -->
                <button type="button" data-dropdown-toggle="notificat" class="p-2 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700">
                ...
                <div class="flex items-center ml-3">
                    <div>
                        <button type="button" class="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button-2" aria-expanded="false" data-dropdown-toggle="dropdown-2">
                            ...
                            <x-icon name="user-circle" class="w-8 h-8 rounded-full text-gray-800 dark:text-gray-200" />
                        </button>
                    </div>
                    <!-- Dropdown menu -->
                    @auth()
                        <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown-2">
                            <div class="px-4 py-3" role="none">
                                ...
                                <p class="text-sm font-medium text-gray-900 truncate dark:text-gray-300" role="none">
                                    {{ \Illuminate\Support\Facades\Auth::getUser()->email  }}
                                </p>
                            </div>
                            <ul class="py-1" role="none">
                                ...
                                <li class="w-full">
                                        <form method="POST" action="{{ route('logout') }}">
                                            @csrf
                                            <x-button class="w-full" type="submit" negative>Logout</x-button>
                                        </form>
                                </li>
                            </ul>
                        </div>
