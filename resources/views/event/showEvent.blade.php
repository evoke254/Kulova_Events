<x-guest-layout>
    ...
    <div class="bg-white">
        ...
        <div class="isolate">
            ...
            <div class="relative isolate -z-10 overflow-hidden bg-gradient-to-b from-indigo-100/20">
                ...
                <div class="mx-auto max-w-7xl py-32 sm:py-40 lg:px-8">
                    <div class="mx-auto lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-6 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">
                        ...
                        <img src="{{ asset('storage/'. $event->images()->first()->image)  }}" alt=""  class="mt-10 aspect-[6/5] w-full max-w-lg rounded-2xl object-cover sm:mt-16 lg:mt-0  lg:max-w-none xl:row-span-2 xl:row-end-2 xl:mt-36">
                        @endif
                    </div>
                </div>
            ...
            <!-- Content section -->
            <div class="my-16 flex justify-center overflow-hidden sm:mt-40 h-screen">



                <div id="default-carousel" class="relative w-3/4" data-carousel="slide">
                    <!-- Carousel wrapper -->
                    <div class="relative min-h-min overflow-hidden rounded-lg h-screen">
