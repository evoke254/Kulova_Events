<x-guest-layout>
    ...
    <section class="bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 min-h-screen ">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 mt-10">
            <div class="mx-auto mt-16 text-center lg:mb-16 mb-8">
                ...
                <article class="mx-auto w-full format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 my-auto align-middle gap-2 ">
                        ...
                        <div id="default-carousel" class="relative w-full self-center " data-carousel="slide">
                            <div class="relative h-96 overflow-hidden rounded-lg border border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 bg-white dark:bg-gray-900 mt-10 ">
                    <div class="md:mt-16">
    @livewire('view-event', ['event' => $event])
                    </div>
                @if($event->elections()->count())
                    ...
                    <div class="">
                        <div class="py-3 px-4 mx-auto ">
                            ...
                            <!-- Timeline section -->
                            <div class="mx-auto -mt-8 px-6 lg:px-8 gap-y-2">
                                <div class="my-2 mb-4 grid  grid-cols-1 mx-auto  lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-6 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">


                                    <ul role="list" class="">
                                        @foreach($event->elections as $election)
                                            <li class="overflow-hidden rounded-xl border border-gray-200 dark:border-gray-700 my-2">
