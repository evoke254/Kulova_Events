    ...
    */
    ...
    'profiles' => [
        ...
        'adminTemplate' => [
            ...
            'toolbar' => 'table hr | image link emoticons |undo redo removeformat | fontselect formatselect fontsizeselect | bold italic underline| align | numlist bullist | forecolor backcolor | code fullscreen',
            'upload_directory' => public_path('storage/images/tinyUpload'),
            'custom_configs' => [
                'resize' => true,
